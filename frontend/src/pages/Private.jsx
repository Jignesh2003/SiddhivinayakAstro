      ...
      <div className="max-w-4xl bg-white p-10 rounded-2xl shadow-lg mt-16 md:mt-24">
        ...
        <div className="mt-8">
          ...
          <ul className="mt-2 space-y-2 text-gray-600 list-disc list-inside">
            ...
            <li>
              Order Information (billing/shipping address, payment details)
            </li>
            <li>
              Customer Support Information (details you provide during support
              interactions)
            </li>
          </ul>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            We collect information necessary to process your order such as
            contact details, payment information, and shipping address.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            When you contact our support, we collect relevant information
            including:
          </p>
          <ul className="mt-2 space-y-2 text-gray-600 list-disc list-inside">
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            ...
            knowingly collect data from minors. If discovered, we will delete
            the data.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            We use personal data for targeted advertising, including retargeting
            and personalized promotions. You can opt out via your browser or ad
            preferences.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">We use your data to:</p>
          <ul className="mt-2 space-y-2 text-gray-600 list-disc list-inside">
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">We process your data under:</p>
          <ul className="mt-2 space-y-2 text-gray-600 list-disc list-inside">
            <li>Consent</li>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            We retain your data only as long as necessary for our services or
            legal obligations. When no longer required, we securely delete it.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            ...
            the updated date and, when significant, notified directly to users.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="text-gray-600 mt-3">
            For any concerns or questions, reach out to us:
          </p>
          <p className="text-gray-600 mt-2">
            📧 Email:{" "}
