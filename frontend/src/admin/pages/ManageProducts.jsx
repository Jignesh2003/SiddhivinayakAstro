      ...
      <table className="w-full table-auto border-collapse text-sm">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="border p-2">How To Wear</th>
            <th className="border p-2">Benefits</th>
            <th className="border p-2">Best Day To Wear</th>
                ...
                <>
                  ...
                  <td className="border p-1">
                    <input
                      ...
                      onChange={handleFieldChange}
                      className="w-full border p-1"
                      placeholder="comma-separated how to wear"
                    />
                  </td>
                  <td className="border p-1">
                    <input
                  ...
                  <td className="border p-1">
                    <input
                      ...
                      onChange={handleFieldChange}
                      className="w-full border p-1"
                      placeholder="comma-separated best day to wear"
                    />
                  </td>
                  <td className="border p-1">
                    <textarea
